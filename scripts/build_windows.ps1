...
& .venv\Scripts\python.exe -c "from PIL import Image; Image.open('src/neo/app/assets/neo-cosmic-v1.png').convert('RGBA').save('build/neo.ico', sizes=[(16,16),(32,32),(48,48),(64,64),(128,128),(256,256)])"
